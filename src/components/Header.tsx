...
export default function Header() {
  return (
    <header className="px-5 pt-14 pb-10">
      <div className="max-w-[1200px] mx-auto flex flex-wrap gap-8 items-start justify-between">
        <div className="flex gap-5 items-center min-w-[280px] flex-1">
          <div
        ...
        <div
          className="flex-1 min-w-[280px] max-w-[420px] rounded-[10px]"
